            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 - Presented by <a class="text-decoration-none text-dark" href="{{ route('refresh') }}" target="_blank">Toms</a> </span>
