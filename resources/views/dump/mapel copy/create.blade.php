            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('mapel.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="ampu10" placeholder="Jam Ampu Pada Kelas 10" name="ampu1">
                    </div>
                    <div class="form-group">
                        <label for="ampu11">Jam Ampu Kelas 11</label>
                        <input type="number" class="form-control" id="ampu11" placeholder="Jam Ampu Pada Kelas 11" name="ampu2">
                    </div>
                    <div class="form-group">
                        <label for="ampu12">Jam Ampu Kelas 12</label>
                        <input type="number" class="form-control" id="ampu12" placeholder="Jam Ampu Pada Kelas 12" name="ampu3">
                    </div>
