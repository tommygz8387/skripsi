                    ...
                    <div class="row justify-content-between mx-0">
                        <div class="cols">
                            <p class="card-description">
                                Berisi daftar ajar berdasarkan guru
                            </p>
                        </div>
                        <div class="cols">
                            ...
                            <div class="input-group mb-3">
                                <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{ route('jadwal.findGuru') }}">
                                    @csrf
                                    <div class="input-group">
                                        <select class="form-control" id="inputGroupSelect04"
                                            aria-label="Example select with button addon" name="guru_id" required>
