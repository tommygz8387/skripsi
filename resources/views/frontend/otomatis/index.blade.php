                    ...
                    <div class="row m-auto">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="alpha" placeholder="Nilai Alpha" name="alpha" required step=".01">
                            </div>
                            <div class="form-group">
                                <label for="beta">Beta (&beta;)</label>
                                <input type="number" class="form-control" id="beta" placeholder="Nilai Beta" name="beta" required step=".01">
                            </div>
                            <div class="form-group">
                                <label for="q">Nilai Q</label>
                                <input type="number" class="form-control" id="q" placeholder="Nilai Q" name="q" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="rho">Rho (&rho;)</label>
                                <input type="number" class="form-control" id="rho" placeholder="Nilai Rho" name="rho" required step=".01">
                            </div>
                            <div class="form-group">
                                <label for="tau">&tau;ij</label>
                                <input type="number" class="form-control" id="tau" placeholder="Nilai &tau;ij" name="tau" required step=".01">
                            </div>
